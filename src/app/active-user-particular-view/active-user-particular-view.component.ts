...
@Component({
  selector: 'app-active-user-particular-view',
  templateUrl: './active-user-particular-view.component.html',
  styleUrls: ['./active-user-particular-view.component.css']
})
export class ActiveUserParticularViewComponent implements OnInit {
private login: Login;
