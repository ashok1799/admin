...
@Component({
  selector: 'app-dailywage-plan-associatecompany',
  templateUrl: './dailywage-plan-associatecompany.component.html',
  styleUrls: ['./dailywage-plan-associatecompany.component.css']
})
export class DailywagePlanAssociatecompanyComponent implements OnInit {
private login: Login;
