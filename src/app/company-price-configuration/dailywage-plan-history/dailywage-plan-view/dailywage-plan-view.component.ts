...
@Component({
  selector: 'app-dailywage-plan-view',
  templateUrl: './dailywage-plan-view.component.html',
  styleUrls: ['./dailywage-plan-view.component.css']
})
export class DailywagePlanViewComponent implements OnInit {
private login: Login;
