...
@Component({
  selector: 'app-priority-plan-associatecompany',
  templateUrl: './priority-plan-associatecompany.component.html',
  styleUrls: ['./priority-plan-associatecompany.component.css']
})
export class PriorityPlanAssociatecompanyComponent implements OnInit {
private login: Login;
