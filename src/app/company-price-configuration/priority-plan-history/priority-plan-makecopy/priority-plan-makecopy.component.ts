...
@Component({
  selector: 'app-priority-plan-makecopy',
  templateUrl: './priority-plan-makecopy.component.html',
  styleUrls: ['./priority-plan-makecopy.component.css']
})
export class PriorityPlanMakecopyComponent implements OnInit {
private login: Login;
