...
@Component({
  selector: 'app-company-companies-plan-edit',
  templateUrl: './company-companies-plan-edit.component.html',
  styleUrls: ['./company-companies-plan-edit.component.css']
})
export class CompanyCompaniesPlanEditComponent implements OnInit {
  ...
  ngOnInit() {
        ...
        .map(res => res.json())
            .subscribe(
                    ...
                    error => alert(error),
                    () => {
                            this.companyplan = this.data.normal;
...
this.companyplan[1].salary_limit = price;
console.log(this.companyplan[1].salary_limit);
}
