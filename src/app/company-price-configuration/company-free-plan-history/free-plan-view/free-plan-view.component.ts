...
@Component({
  selector: 'app-free-plan-view',
  templateUrl: './free-plan-view.component.html',
  styleUrls: ['./free-plan-view.component.css']
})
export class FreePlanViewComponent implements OnInit {
private login: Login;
