...
import { Associate } from './company'

@Component({
  selector: 'app-free-plan-associatecompany',
  templateUrl: './free-plan-associatecompany.component.html',
  styleUrls: ['./free-plan-associatecompany.component.css']
})
export class FreePlanAssociatecompanyComponent implements OnInit {
private login: Login;
