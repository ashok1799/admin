...
@Component({
  selector: 'app-free-plan-makecopy',
  templateUrl: './free-plan-makecopy.component.html',
  styleUrls: ['./free-plan-makecopy.component.css']
})
export class FreePlanMakecopyComponent implements OnInit {
private login: Login;
