...
@Component({
  selector: 'app-company-prioritysourcing-plan-edit',
  templateUrl: './company-prioritysourcing-plan-edit.component.html',
  styleUrls: ['./company-prioritysourcing-plan-edit.component.css']
})
export class CompanyPrioritysourcingPlanEditComponent implements OnInit {
    private login: Login;
  ...
  ngOnInit() {
        ...
        .map(res => res.json())
            .subscribe(
                    ...
                    error => alert(error),
                    () => {
                            this.companyplan = this.data.priority;
