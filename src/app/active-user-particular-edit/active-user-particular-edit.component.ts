...
@Component({
  selector: 'app-active-user-particular-edit',
  templateUrl: './active-user-particular-edit.component.html',
  styleUrls: ['./active-user-particular-edit.component.css']
})
export class ActiveUserParticularEditComponent implements OnInit {
private login: Login;
...
public meta: any;
  ...
  ngOnInit() {
            ...
            console.log('user edit page',this.employee_id);
                });
                    ...
                    error => alert(error),
                     () => {
                              this.meta = this.userCreation.meta;
                               console.log('user details particular', this.userCreation);
...
onStaff(staff: string) {
    console.log(' FILTER ', staff);
    this.filter = this.meta.reporting_staff.filter(reporting_staff => reporting_staff.name == staff);
    console.log(' FILTER ', this.filter);
    //this.userCreation.city = this.filter[0].city_name;
    //this.userCreation.state = this.filter[0].state_name;
  }
